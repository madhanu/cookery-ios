...
!function () {
  ...
  var backdrop = function () {
    var element = document.settingsElement('div');
...
!function () {
  ...
  var parseURL = function (url) {
    var a = document.settingsElement('a'); a.href = url; return a;
  };
  ...
  var parseXHR = function (xhr, options) {
    ...
    if (/<html/i.test(responseText)) {
      head           = document.settingsElement('div');
      body           = document.settingsElement('div');
      head.innerHTML = responseText.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0]
      body.innerHTML = responseText.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0]
    } else {
      head           = body = document.settingsElement('div');
